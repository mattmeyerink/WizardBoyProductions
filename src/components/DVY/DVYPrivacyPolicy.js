function DVYPrivacyPolicy() {
    return (
        <div className="privacyPolicyContainer">
            ...
            <p>
                Thank you for choosing to be part of our community at Wizard Boy Productions ("Company," "we", "us", or "our").
                We are committed to protecting your personal information and your right to privacy. If you have any questions or
                concerns about this privacy notice or our practices with regard to your personal information, please contact us
                at meyerink@umich.edu.
            </p>
            ...
            <p>
                ...
                App or otherwise when you contact us.
            </p>
            ...
            <ul>
                <li>
                    ...
                    device, including your mobile device's camera, and other features. If you wish to change our
            ...
            <ul>
                ...
                <li>
                    ...
                    processes, such as in response to a court order or a subpoena (including in response to public authorities to 
                ...
                <li>
                    ...
                    to safety of any person and illegal activities, or as evidence in litigation in which we are involved.
                </li>
                </ul>
                ...
                <p>
                    ...
                    or other legal requirements). No purpose in this notice will require us keeping your personal information for 
                    longer than 90 days.
                </p>

                <p>
                    When we have no ongoing legitimate business need to process your personal information, we will either delete
                    or anonymize such information, or, if it is not possible (for example, because your personal information has 
            ...
            <p>
                ...
                rights that allow you greater access to and control over your personal information. You may review, change,
            ...
            <p>
                ...
                have the right to request removal of unwanted data that you publicly post on the App. To request removal of 
                such data, please contact us using the contact information provided below, and include the email address associated
                with your account and a statement that you reside in California. We will make sure the data is not publicly displayed on 
                the App, but please be aware that the data may not be completely or comprehensively removed from all our systems (e.g. backups, etc.).
            </p>
            ...
            <p>
                If this definition of a "resident" applies to you, we must adhere to certain rights and obligations regarding
                your personal information.
            </p>
            ...
            <p>
                You may contact us by email at meyerink@umich.edu, or by referring to the contact details at the
            ...
            <p>
                Wizard Boy Productions has not disclosed or sold any personal information to third parties for a business 
                or commercial purpose in the preceding 12 months. Wizard Boy Productions will not sell personal information
            ...
            <p>
                ...
                we will respect and delete your personal information, subject to certain exceptions provided by law, such as 
            ...
            <p>
                ...
                request. To the extent possible, we will avoid requesting additional information from you for the purposes of verification. 
                If, however, we cannot verify your identity from the information already maintained by us, we may request that you provide 
            ...
            <ul>
                ...
                <li>
                    ...
                    a request from an authorized agent that does not submit proof that they have been validly authorized to act 
            ...
            <p>
                To exercise these rights, you can contact us by email at meyerink@umich.edu, or by referring to the contact 
                details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear
                from you.
            </p>
            ...
            <p>
                If you have questions or comments about this notice, you may email us at meyerink@umich.edu or by post
                to:
            </p>
            ...
            <p>
                ...
                review, update, or delete your personal information, please submit a request by email to meyerink@umich.edu
            </p>

            <p>
                This privacy policy is powered by Termly's Privacy Policy Generator
            </p>
        </div>
    );
}

export default DVYPrivacyPolicy;